			...
			<form data-toggle="validator" role="form">
				...
				<div class="row">
					<div class="col-7">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="colFormLabel"
									placeholder="ex)고길동" maxlength="10">
							</div>
						</div>
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							<span id="notice">*</span>지역</label>
							<div class="col-sm-3" id="select0">서울시</div>
						...
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							<span id="notice">*</span>고양이<br>양육경험</label>
						...
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							<span id="notice">*</span>직업구분</label>
						...
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							<span id="notice">*</span>결혼여부</label>
							<div class="col-sm-10" id="yesno2">
								<div class="custom-control custom-radio custom-control-inline">
						...
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							<span id="notice">*</span>가족<br>구성원 수</label>
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline11"
										name="customRadioInline5" class="custom-control-input">
							...
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline14"
										name="customRadioInline6" class="custom-control-input">
							...
							<div class="col-sm-10" id="yesno1">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline17"
										name="customRadioInline7" class="custom-control-input">
						...
						<div class="form-group row">
							<label for="colFormLabel" class="col-sm-2 col-form-label">
							키우는(<span id="notice1">*</span>)<br>반려동물</label>
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline19"
										name="customRadioInline8" class="custom-control-input">
							...
							<label for="colFormLabel" class="col-sm-10 col-form-label blue">*
								키우는 반려동물 종류/나이/성별/중성화여부</label> <br>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="colFormLabel"
									placeholder="ex)강아지/2살/수컷/중성화했어요" maxlength="20">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline23"
										name="customRadioInline9" class="custom-control-input">
							...
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline27"
										name="customRadioInline10" class="custom-control-input">
							...
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline30"
										name="customRadioInline11" class="custom-control-input">
							...
							<div class="col-sm-10" id="yesno">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="customRadioInline32"
										name="customRadioInline12" class="custom-control-input">
					...
					<div class="form-group">
						...
						<div class="col-12 row">
							<textarea class="form-control" aria-label="With textarea"
								id="exampleFormControlTextarea" rows="4" maxlength="300">냥이 사연이 너무 안타깝네요.. 
제가 평소에 고양이를 키우려고 알아보고 있었는데, 돈을 주고 사는 것보다는 입양을 통해서 
불쌍한 아이들을 도와주고 싶은 마음에 신청하게 되었습니다.</textarea>
						</div>
						<div id="textCounter" class="col-12 text-right">
							<div class="textCounter declaration">
								<span id="counter">0</span> / 300
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-12 row">
							<textarea class="form-control" aria-label="With textarea"
								id="exampleFormControlTextarea1" rows="4" maxlength="300"></textarea>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-12 row">
							<textarea class="form-control" aria-label="With textarea"
								id="exampleFormControlTextarea2" rows="4" maxlength="300"></textarea>
						</div>
						<div id="textCounter" class="col-12 text-right">
							<div class="textCounter declaration">
				...
				<div class="col text-center">
					...
					<a id="completebtn" href="#"><button
							class="btn btn-primary btn-lg" type="submit">작성완료</button></a>
				</div>
			</form>
		</div>
	</div>
